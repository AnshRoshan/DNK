...
const Contact = () => {
  return (
<Layout>
  <div class="mx-auto max-w-7xl px-4 text-black">
          ...
          <div class="px-2 md:px-12">
            ...
            <form action="" class="mt-8 space-y-4">
              ...
              <div class="grid w-full  items-center gap-1.5">
                ...
                <input
                  class="text-black flex h-10 w-full rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-0 dark:border-gray-700 dark:text-gray-50 dark:focus:ring-gray-400 dark:focus:ring-offset-gray-900"
                  type="text"
                  id="email"
                  placeholder="Email"
                />
