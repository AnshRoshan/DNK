  ...
  return (
    <Layout>
      ...
      <div className='row contactus '>
        ...
        <div className='col-md-4 mx-12'>
        <img
  className='mt-[99.5cm] mx-auto h-90'
  src='/images/contactus.jpeg'
  alt='contactus'
  style={{ width: "50%" }}
/>

          <h1 class='text-center my-8 font-bold text-2xl'>Privacy Policy</h1>

          <p> <strong>Last updated:</strong> September 26, 2023</p>
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Dak Ghar Niryat Kendra, India.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to DNK, accessible from{" "}
                <a
                  href='https://dnkweb.vercel.app/#'
                  rel='external nofollow noopener'
                  target='_blank'
                >
                  https://dnkweb.vercel.app/#
                </a>
              </p>
            </li>
            <li>
